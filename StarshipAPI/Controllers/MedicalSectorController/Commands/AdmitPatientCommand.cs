...
{
    public class AdmitPatientCommand : CommandWithDbContext, ICommandFactory
    {
        public string CommandName { get { return "AdmitPatientCommand"; } }

        public string CommandDescription { get { return "Utilize credits and resources to admit patient"; } }

        public AdmitPatientCommand(DbContext context) : base(context) { }
        ...
        {
            return new AdmitPatientCommand(this.Context);
        }
