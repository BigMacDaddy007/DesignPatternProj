...
{
    public class MiningExpeditionCommand : CommandWithDbContext, ICommandFactory
    {
        public string CommandName { get { return "MiningExpeditionCommand"; } }

        public string CommandDescription { get { return "Spend Energy, Resources, and Credits to run a mining Expedition"; } }

        public MiningExpeditionCommand(DbContext context) : base(context) { }
